/*
  ...
  - The values [NOT_ASSIGNED,NOT_ACCEPTED,NOT_STARTED_YET,PICKED_UP,READY_TO_DELIVER] on the enum `ParcelStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ParcelStatus_new" AS ENUM ('PENDING', 'ACTIVE', 'STARTED', 'ALREADY_DELIVERED', 'FAILED_DELIVERY', 'INCOMPLETE');
